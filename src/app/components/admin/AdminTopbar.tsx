    ...
    <header className="relative border-b border-[#81D4FA]/20 bg-linear-to-r from-white/90 via-[#F5F5DC]/30 to-white/90 backdrop-blur-xl px-8 py-8 shadow-lg">
      ...
      <div className="flex flex-wrap items-center justify-between gap-8">
        <div className="flex-1">
          <h1 className="text-5xl font-black bg-linear-to-r from-[#2E7D32] to-[#1b5e20] bg-clip-text text-transparent">{title}</h1>
        ...
        <div className="flex items-center gap-4">
          ...
          <button className="group relative flex items-center gap-2 rounded-xl border border-[#2E7D32]/20 bg-white/40 backdrop-blur-sm px-4 py-3 text-sm font-medium text-[#2E7D32] transition-all duration-300 hover:border-[#2E7D32]/40 hover:bg-white/60 hover:shadow-lg">
            ...
            <span className="absolute -right-2 -top-2 h-2.5 w-2.5 rounded-full bg-linear-to-br from-[#E74C3C] to-[#C0392B] shadow-lg" />
          </button>
