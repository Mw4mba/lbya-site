    ...
    >
      <section>
        <div className="mb-10 flex items-center justify-between">
          <div>
            <h2 className="text-3xl font-bold bg-gradient-to-r from-[#2E7D32] to-[#1b5e20] bg-clip-text text-transparent">Key Metrics</h2>
      ...
      <section>
        <div className="mb-10 flex items-center justify-between">
          <div>
            <h2 className="text-3xl font-bold bg-gradient-to-r from-[#2E7D32] to-[#1b5e20] bg-clip-text text-transparent">Performance Overview</h2>
      ...
      <section>
        <div className="mb-10 flex items-center justify-between">
          <div>
            <h3 className="text-3xl font-bold bg-gradient-to-r from-[#2E7D32] to-[#1b5e20] bg-clip-text text-transparent">Recent activity</h3>
            <p className="mt-2 text-sm font-medium text-[#37474F]/60">Latest system events</p>
          </div>
        </div>
        <ul className="rounded-2xl border border-[#2E7D32]/15 bg-gradient-to-br from-white via-white to-[#F5F5DC]/40 p-8 shadow-lg">
          {activityFeed.map((item) => (
            <li key={item} className="flex items-start gap-4 rounded-xl p-4 transition-all duration-200 hover:bg-[#2E7D32]/5 group">
              <span className="inline-block h-2 w-2 rounded-full bg-[#2E7D32] animate-pulse flex-shrink-0 mt-2" />
